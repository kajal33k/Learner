<x-layouts.app :title="__('Edit grid')">
    <div class="relative w-full h-44 flex items-center justify-center">
        ...
        <!-- Title -->
        <h1 class="relative text-white text-4xl font-extrabold drop-shadow-lg">Edit grid</h1>
    </div>

    <!-- Form Card -->
    <div class="max-w-3xl mx-auto mt-8 bg-black p-6 rounded-lg shadow-lg">
        <h2 class="text-2xl font-bold text-white800 mb-4">Update grid</h2>
        ...
        <!-- Edit Form -->
        <form action="{{ route('backend.grid.update', $grid->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" id="title" name="title" value="{{ old('title', $grid->title) }}" 
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description" rows="4" 
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-300" required>{{ old('description', $grid->description) }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                @if($grid->image)
                    <img src="{{ asset('storage/' . $grid->image) }}" class="h-32 w-32 object-cover rounded-md border border-gray-300 mt-2">
                @else
